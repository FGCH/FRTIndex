...
//////// Non-parametric Time-varying Panel Data ////////////////////////////////

///// Note: ssc install xtnptimevar

///// First test
xtnptimevar dratecov lltratecov lfrt lpubdebtgdp linfl lus3mrate loecdgrowth ///
    lvix, stub(test) forcereg bootstrap saving(~/Desktop)

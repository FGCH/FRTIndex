...
// FRT
xtreg dltrate lltrate lfrt dfrt lstrucbalgdp dstrucbalgdp lpubdebtgdp ///
...
// HRV
xtreg dltrate lltrate lhrv_mean dhrv_mean lstrucbalgdp dstrucbalgdp ///
...
// OBI
xtreg dltrate lltrate lobi_filled dobi_filled lstrucbalgdp dstrucbalgdp ///
    lpubdebtgdp dpubdebtgdp linfl dinfl lus3mrate dus3mrate loecdgrowth ///
    doecdgrowth lvix dvix, cluster(ccode1) i(ccode1) fe vsquish noomit

//////// Examine Change in long-term rate spread
//FRT
xtreg dltspreadus lltspreadus lfrt dfrt lstrucbalgdp dstrucbalgdp lpubdebtgdp ///
    dpubdebtgdp linfl dinfl lus3mrate dus3mrate loecdgrowth doecdgrowth lvix ///
    dvix, cluster(ccode1) i(ccode1) fe vsquish noomit
...
// HRV
xtreg dltspreadus lltspreadus lhrv_mean dhrv_mean lstrucbalgdp dstrucbalgdp ///
    lpubdebtgdp dpubdebtgdp linfl dinfl lus3mrate dus3mrate loecdgrowth ///
    doecdgrowth lvix dvix, cluster(ccode1) i(ccode1) fe vsquish noomit
...
// OBI
xtreg dltspreadus lltspreadus lobi_filled dobi_filled  lstrucbalgdp ///
    dstrucbalgdp lpubdebtgdp dpubdebtgdp linfl dinfl lus3mrate dus3mrate ///
...
xtreg dratecov lltratecov lfrt dfrt lstrucbalgdp dstrucbalgdp lpubdebtgdp ///
    dpubdebtgdp linfl dinfl lus3mrate dus3mrate loecdgrowth doecdgrowth lvix ///
    dvix, cluster(ccode1) i(ccode1) fe vsquish noomit
    regsave using "tables/FRT3.dta", detail(all) replace table(Volatility, ///
        order(regvars r2) format(%5.2f) paren(stderr) asterisk())
...
xtreg dratecov lltratecov lfrt dfrt lstrucbalgdp dstrucbalgdp lpubdebtgdp ///
    ...
    fe vsquish noomit
    regsave using "tables/FRT4.dta", detail(all) replace ///

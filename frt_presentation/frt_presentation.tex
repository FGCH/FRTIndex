...
\section{Motivation}
    ...
    \frame{
        ...
        Recent supervisory transparency indexes generally use \textbf{surveys} and \textbf{sum} dichotomous responses.
        \begin{itemize}
    ...
    \frame{
        ...
        \begin{itemize}
            \item Survey methods are \textbf{laborious} to construct.
            \item Survey methods provide only brief windows, \textbf{not time series}.
            \item Summing dichotomous responses \textbf{assumes} that each item should be \textbf{weighted equally}.
    ...
    \frame{
        ...
        \begin{center}
            then rescentered by $\frac{\alpha_{c,1990}-\bar{\alpha_{1990}}}{SD_{\alpha}_{1990}}$
        \end{center}
    ...
    \frame{
        ...
        The willingness of a country to report \textbf{minimally credible} information about its financial system to international instituions and investors.
    }

    \frame{
        \frametitle{FRT Index Overview}
...
\section{Comparison to other methods}
    ...
    \frame{
        \frametitle{Comparision to frequency measure}
        \begin{center}
    ...
    \frame{
        \frametitle{Comparision to survey/frequency measures}
...
\section{Conclusion}
    ...
    \frame{
        \frametitle{To-Do}
        \begin{itemize}
            \item Understand why countries increase/decrease their reporting.
            \item Examine how reporting is associated with economic outcomes:
                \begin{itemize}
                    \item Investment flows
